    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-black text-white font-sans selection:bg-yellow-500 selection:text-black">
      ...
      <main className="relative z-10 flex flex-col items-center gap-12 px-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-8">
          ...
          <div
            className="px-8 py-4 rounded-xl border border-zinc-800 text-zinc-400 font-medium hover:bg-zinc-900 transition-all cursor-not-allowed group"
          >
            ADMIN DASHBOARD <span className="text-[10px] ml-2 px-2 py-0.5 rounded-full bg-zinc-800">COMING SOON</span>
          </div>
        </div>

        {/* Footer info */}
        <div className="mt-16 text-zinc-700 text-[10px] tracking-widest uppercase">
          &copy; 2026 Darklands Festival • Antwerp, Belgium
        </div>
      </main>
    </div>
  );
